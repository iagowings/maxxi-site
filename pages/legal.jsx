...
const LEGAL_CONTENT = {
  ...
  "politica-de-cookies-br": {
    ...
    sections: [
      ...
      ["Como usamos", "Utilizamos cookies necessários (para lembrar preferências de navegação) e, mediante o seu consentimento, cookies de medição e publicidade para entender o desempenho do site e das nossas campanhas."],
      ["Cookies de terceiros — Meta (Facebook e Instagram)", "Com o seu consentimento, utilizamos o Meta Pixel, da Meta Platforms Ireland Ltd., para medir o resultado dos anúncios veiculados no Facebook e no Instagram e exibir anúncios a quem já visitou o site. O Pixel registra páginas visitadas e cliques em botões — nunca dados de saúde, resultados de exames, nome, CPF ou informações que você envie pelo WhatsApp. Saiba mais em facebook.com/privacy/policy."],
      ["Gerenciar cookies", "Você pode aceitar ou recusar os cookies de medição no aviso exibido na primeira visita, e pode revogar a escolha a qualquer momento apagando os dados do site no seu navegador. Também é possível bloquear cookies nas configurações do navegador — algumas funcionalidades podem ser afetadas."],
  ...
  "politica-de-privacidade": {
    ...
    sections: [
      ...
      ["Para que usamos", "Para agendar e realizar consultas e exames, entrar em contato sobre o seu atendimento, cumprir obrigações legais e sanitárias de guarda de prontuários e laudos, e — apenas com o seu consentimento — medir a audiência do site e o resultado das nossas campanhas de anúncios."],
      ["Bases legais", "Execução de contrato e procedimentos preliminares (agendamentos), tutela da saúde por profissionais de saúde (atendimento clínico), cumprimento de obrigação legal (guarda de registros) e consentimento (cookies de medição e publicidade)."],
      ["Publicidade e Meta Pixel", "Anunciamos no Facebook e no Instagram. Com o seu consentimento, o Meta Pixel registra visitas e cliques neste site para medir o desempenho dos anúncios e formar públicos. Não enviamos à Meta — nem a nenhum outro parceiro de publicidade — dados de saúde, exames, laudos, diagnósticos ou qualquer informação sensível. Você pode recusar esses cookies sem prejuízo ao atendimento."],
